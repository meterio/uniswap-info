...
export function getSwapLink(token0Address, token1Address = null) {
  if (!token1Address) {
    return `https://voltswap.finance/#/swap?inputCurrency=${token0Address}`
  } else {
    return `https://voltswap.finance/#/swap?inputCurrency=${token0Address === '0xc02aaa39b223fe8d0a0e5c4f27ead9083c756cc2' ? 'ETH' : token0Address
...
export const urls = {
  showTransaction: tx => `https://explorer.thetatoken.org/txs/${tx}/`,
  showAddress: address => `https://explorer.thetatoken.org/address/${address}/`,
  showToken: address => `https://explorer.thetatoken.org/address/${address}/`,
  showBlock: block => `https://explorer.thetatoken.org/block/${block}/`
}
