...
export const urls = {
  showTransaction: tx => `https://scan.meter.io/tx/${tx}/`,
  showAddress: address => `https://scan.meter.io/address/${address}/`,
  showToken: address => `https://scan.meter.io/address/${address}/`,
  showBlock: block => `https://scan.meter.io/block/${block}/`
}
