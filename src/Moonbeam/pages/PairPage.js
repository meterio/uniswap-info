...
function PairPage({ pairAddress, history }) {
  ...
  useEffect(() => {
    ...
    params.append("network", "moonbeam")
          ...
          <DashboardWrapper>
            ...
            >
              <FixedPanel onClick={() => history.push(`/token/${token0?.id}`)}>
                <RowFixed>
                  <TokenLogo symbol={token0?.symbol} address={token0?.id} size={'16px'} />
              ...
              <FixedPanel onClick={() => history.push(`/token/${token1?.id}`)}>
                <RowFixed>
                  <TokenLogo symbol={token1?.symbol} address={token1?.id} size={'16px'} />
                  <TYPE.main fontSize={'16px'} lineHeight={1} fontWeight={500} ml={'4px'}>
                    {token0 && token1
                ...
                <Panel style={{ height: '100%' }}>
                  <AutoColumn gap="20px">
                    ...
                    <Hover onClick={() => history.push(`/token/${token0?.id}`)} fade={true}>
                      <AutoRow gap="4px">
                        <TokenLogo symbol={token0?.symbol} address={token0?.id} />
                    ...
                    <Hover onClick={() => history.push(`/token/${token1?.id}`)} fade={true}>
                      <AutoRow gap="4px">
                        <TokenLogo symbol={token1?.symbol} address={token1?.id} />
                        <TYPE.main fontSize={20} lineHeight={1} fontWeight={500}>
                          <RowFixed>
              ...
              >
                <TokenDetailsLayout>
                  ...
                  <ButtonLight color={backgroundColor}>
                    <Link color={backgroundColor} external href={'https://blockscout.moonbeam.network/address/' + pairAddress}>
                      View on Blockscout ↗
                    </Link>
                  </ButtonLight>
                </TokenDetailsLayout>
